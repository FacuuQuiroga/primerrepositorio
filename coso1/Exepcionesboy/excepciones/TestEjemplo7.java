package excepciones;
/* Ejemplo7: Igual al ejemplo6 pero levantando en concreto la excepcion ArithmeticException

             No se captura el error en el metodo en el que se produce sino que se levanta
...
/**Devuelve el cociete de una division entre 2 numeros
 * 
 * @param nro1
 * @param nro2
 * @return cociente de 2 numeros
 * @throws ArithmeticException no se puede dividir entre cero
 */
	// Calcular cociente
	static public int mDividir(int nro1, int nro2) throws ArithmeticException {
		int cociente = 0;

		if (nro2 == 0)
			throw new ArithmeticException(
					"No se puede realizar la division del " + nro1 + " entre " + nro2 + " porque daria un error");
		else
			cociente = nro1 / nro2;
