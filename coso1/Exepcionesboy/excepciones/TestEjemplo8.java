package excepciones;
/* Ejemplo8: Igual al ejemplo7 pero levantando en concreto una excepcion de la clase
             ErrorAritmeticoException creada para controlar este error.
...
public class TestEjemplo8 {
	...
	static public int mDividir(int nro1, int nro2) throws ErrorAritmeticoException {
		...
		if (nro2 == 0)
			throw new ErrorAritmeticoException(
